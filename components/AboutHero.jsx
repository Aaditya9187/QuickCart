  ...
  return (
    <section className="relative py-24 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        {/* Tag Label */}
        <span className="inline-block text-indigo-600 font-semibold tracking-widest uppercase text-sm mb-5 px-5 py-2 bg-indigo-50 rounded-full">
          About QuickCart
        </span>
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight text-slate-900">
          ...
          <span className="text-indigo-600">Digital Lifestyle</span>
        </h1>
          ...
          {features.map((item, index) => (
            ...
            >
              <div className="flex justify-center mb-5">
                <div className="w-14 h-14 flex items-center justify-center rounded-xl bg-indigo-50 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-all">
                  {item.icon}
                </div>
              </div>
