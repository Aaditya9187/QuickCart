...
export default function HeroSection() {
  return (
    <section className="relative py-24 bg-gradient-to-b from-indigo-50 to-white overflow-hidden">
      ...
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-indigo-100 rounded-full blur-3xl opacity-60 animate-pulse"></div>
      ...
      <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
        ...
        <a
          href="#contact-form"
          className="inline-flex items-center gap-3 bg-indigo-500 text-white font-bold px-10 py-4 rounded-3xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 text-lg"
        >
